...
nrow(polls)
polls$remain<-as.numeric(str_replace(polls$remain, "%", ""))/100
polls$leave<-as.numeric(str_replace(polls$leave, "%", ""))/100

#polls$remain<-parse_number(polls$remain)/100

polls$undecided<-str_replace(polls$undecided,"N/A","0")
polls$undecided<-as.numeric(str_replace(polls$undecided, "%", ""))/100
